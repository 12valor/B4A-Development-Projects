...
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
...
public b4a.example.b4xdialog _vvvvvvvvvvvvvvvvvvv0 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new Object();
...
_vvvvvvvvvvvvvvvvvvv0 = new b4a.example.b4xdialog();
...
_loadingindicator._vvvvvvvvvvvvvvvv4 /*String*/ ();
...
_vvvvvvvvvvvvvvvvvvv0._vvvvvvvvvvvvvvvvvvvv4 /*boolean*/ ((int) (0));
...
_vvv4.SetLayoutAnimated((int) (0),(int) (0),(int) (0),__c.DipToCurrent((int) (300)),__c.DipToCurrent((int) (60)));
 //BA.debugLineNum = 14;BA.debugLine="mBase.LoadLayout(\"XV_ProgressTemplate\")";
_vvv4.LoadLayout("XV_ProgressTemplate",ba);
 //BA.debugLineNum = 15;BA.debugLine="mBase.SetColorAndBorder(xui.Color_White, 0, 0, 5d";
_vvv4.SetColorAndBorder(_vvv5.Color_White,(int) (0),(int) (0),__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 16;BA.debugLine="LoadingIndicator.Hide";
_loadingindicator._vvvvvvvvvvvvvvvv4 /*String*/ ();
 //BA.debugLineNum = 17;BA.debugLine="mDialog.Initialize(Parent)";
_vvvvvvvvvvvvvvvvvvv0._initialize /*String*/ (ba,_parent);
 //BA.debugLineNum = 18;BA.debugLine="mDialog.ButtonsHeight = -2dip";
_vvvvvvvvvvvvvvvvvvv0._vvvvvvvvvvvvvvvvvvvvv7 /*int*/  = (int) (-__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 19;BA.debugLine="mDialog.BorderWidth = 0";
_vvvvvvvvvvvvvvvvvvv0._vvvvvvvvvvvvvvvvvvvvvv6 /*int*/  = (int) (0);
 //BA.debugLineNum = 20;BA.debugLine="mDialog.BorderCornersRadius = 5dip";
_vvvvvvvvvvvvvvvvvvv0._vvvvvvvvvvvvvvvvvvvvvv5 /*int*/  = __c.DipToCurrent((int) (5));
...
_vvvvv3._vv3 /*String*/ (ba,_label1,_t);
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(Object _text) throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Public Sub ShowDialog (Text As Object)";
 //BA.debugLineNum = 40;BA.debugLine="setText(Text)";
_setvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_text);
 //BA.debugLineNum = 41;BA.debugLine="If mDialog.Visible = False Then";
if (_vvvvvvvvvvvvvvvvvvv0._getvvvvvv4 /*boolean*/ ()==__c.False) { 
 //BA.debugLineNum = 42;BA.debugLine="mDialog.ShowTemplate(Me, \"\", \"\", \"\")";
_vvvvvvvvvvvvvvvvvvv0._vvvvvvvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.keywords.Common.ResumableSubWrapper*/ (this,(Object)(""),(Object)(""),(Object)(""));
 };
