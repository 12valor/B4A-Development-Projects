...
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
...
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = ((int)0xaa0086ff);
 //BA.debugLineNum = 10;BA.debugLine="Public SelectedItems As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 11;BA.debugLine="Public MultiSelectionMinimum As Int = 0";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = (int) (0);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_item,__c.True);
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Clear();
 //BA.debugLineNum = 84;BA.debugLine="SelectedItems.Add(Value)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add(_value);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Initialize();
 //BA.debugLineNum = 27;BA.debugLine="SelectedItems.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Initialize();
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(b4a.example3.customlistview._clvitem _item,boolean _toggle) throws Exception{
int _index = 0;
...
_index = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.IndexOf(_item.Value);
...
if (__c.Not(_toggle)) { 
_item.Panel.setColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2);};
...
if (_index==-1) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add(_item.Value);};
 }else {
 //BA.debugLineNum = 68;BA.debugLine="Item.Color = SelectionColor";
_item.Color = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2;
...
if (_index>-1) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.RemoveAt(_index);};
 };
 //BA.debugLineNum = 72;BA.debugLine="xDialog.SetButtonState(xui.DialogResponse_Positiv";
_vvvvvvvvvvvvv7._vvvvvvvvvvvvvvvvvvvvv3 /*String*/ (_vvv5.DialogResponse_Positive,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getSize()>=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
...
//for
this.state = 4;
group3 = parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0;
index3 = 0;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_item,parent.__c.False);
 if (true) break;
if (true) break;
