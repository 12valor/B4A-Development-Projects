...
public anywheresoftware.b4a.objects.collections.List _vvv6 = null;
public int _vvv7 = 0;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvv0 = null;
public anywheresoftware.b4a.objects.collections.List _vvvv1 = null;
public int _vvvv2 = 0;
public int _vvvv3 = 0;
public int _vvvv4 = 0;
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _vvvv5 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvv6 = null;
...
_vvvv6.SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
 //BA.debugLineNum = 73;BA.debugLine="xfadeIv.SetBitmap(fade.Resize(Width, Height, Fals";
_vvvv6.SetBitmap((android.graphics.Bitmap)(_vvvv5.Resize((int) (_width),(int) (_height),__c.False).getObject()));
...
_vvvv3 = (int) (_width/(double)_columns);
...
{
final int step9 = 1;
final int limit9 = (int) (_vvv6.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit9 ;_i = _i + step9 ) {
 //BA.debugLineNum = 80;BA.debugLine="Dim iv As B4XView = ImageViews.Get(i)";
_iv = new anywheresoftware.b4a.objects.B4XViewWrapper();
_iv = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvv6.Get(_i)));
 //BA.debugLineNum = 82;BA.debugLine="left = left - DigitWidth";
_left = (int) (_left-_vvvv3);
 //BA.debugLineNum = 83;BA.debugLine="iv.SetLayoutAnimated(0, left, TopFromValue(i), D";
_iv.SetLayoutAnimated((int) (0),_left,_vv0(_i),_vvvv3,(int) (_vvvv2*10));
...
_vvvv5 = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private xfadeIv As B4XView";
_vvvv6 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Public Tag As Object";
_vvvv7 = new Object();
 //BA.debugLineNum = 20;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper  _vv4(anywheresoftware.b4a.objects.B4XViewWrapper _lbl) throws Exception{
...
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_vvvv3,(int) (_vvvv2*10));
...
_baseline = (int) (_vvvv2/(double)2-_r.getHeight()/(double)2-_r.getTop());
...
_cvs.DrawText(ba,BA.NumberToString(_i),(float) (_vvvv3/(double)2),(float) (_i*_vvvv2+_baseline),_lbl.getFont(),_lbl.getTextColor(),BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 }
};
...
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper  _vv5(int _clr) throws Exception{
...
_pnl = _vvv5.CreatePanel(ba,"");
 //BA.debugLineNum = 34;BA.debugLine="mBase.AddView(pnl, 0, 0, 0, 0)";
_vvv4.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
 //BA.debugLineNum = 35;BA.debugLine="mdigits = Props.Get(\"Digits\")";
_vvv7 = (int)(BA.ObjectToNumber(_props.Get((Object)("Digits"))));
 //BA.debugLineNum = 36;BA.debugLine="mDuration = Props.Get(\"Duration\")";
_vvvv4 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 37;BA.debugLine="lblTemplate = lbl";
_vvv0 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 38;BA.debugLine="fade = CreateFadeBitmap(xui.PaintOrColorToColor(P";
_vvvv5 = _vv5(_vvv5.PaintOrColorToColor(_props.GetDefault((Object)("FadeColor"),(Object)(_vvv5.Color_White))));
 //BA.debugLineNum = 39;BA.debugLine="For i = 0 To mdigits - 1";
{
final int step10 = 1;
final int limit10 = (int) (_vvv7-1);
_i = (int) (0) ;
...
_vvv6.Add((Object)(_iv.getObject()));
 //BA.debugLineNum = 43;BA.debugLine="mBase.GetView(0).AddView(iv, 0, 0, 0, 0)";
_vvv4.GetView((int) (0)).AddView((android.view.View)(_iv.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
 }
};
...
_vvvv6 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_fadeiv.getObject()));
 //BA.debugLineNum = 48;BA.debugLine="mBase.GetView(0).AddView(fadeIv, 0, 0, 0, 0)";
_vvv4.GetView((int) (0)).AddView((android.view.View)(_fadeiv.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
...
{
final int step2 = 1;
final int limit2 = (int) (_vvvv1.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 123;BA.debugLine="res = res + mValue.Get(i) * Power(10, i)";
_res = (int) (_res+(double)(BA.ObjectToNumber(_vvvv1.Get(_i)))*__c.Power(10,_i));
 }
};
...
_iv.SetLayoutAnimated(_vvvv4,_iv.getLeft(),_vv0(_i),(int) (__c.Max(1,_iv.getWidth())),(int) (__c.Max(1,_iv.getHeight())));
 }
};
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public int  _vv0(int _digit) throws Exception{
int _d = 0;
...
_d = (int)(BA.ObjectToNumber(_vvvv1.Get(_digit)));
 //BA.debugLineNum = 90;BA.debugLine="Return -d * DigitHeight";
if (true) return (int) (-_d*_vvvv2);
