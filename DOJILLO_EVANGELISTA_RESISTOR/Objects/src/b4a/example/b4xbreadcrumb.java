...
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvv2 = null;
...
_vvvvvvvvv2 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvv5 = __c.DipToCurrent((int) (10));
...
_vvvvvvvvv7 = _vvv5.CreatePanel(ba,"Touch");
...
_vvvvvv0._colortoargb(_vvvvvvvvv6,_bcolor);
...
_strokecolor = _vvvvvv0._argbtocolor(_bcolor);
...
{
final int step16 = 1;
final int limit16 = (int) (_vvvvvvvvv1.getSize()-1);
_i = (int) (0) ;
...
_width = _vvvvvvvv3(_left,BA.ObjectToString(_vvvvvvvvv1.Get(_i)),_i==0,_i==_vvvvvvvvv1.getSize()-1,_clrs[(int) (_i%_clrs.length)],_sc);
 //BA.debugLineNum = 79;BA.debugLine="Left = Left + width + offset + 2dip";
_left = (int) (_left+_width+_vvvvvvvvv5+__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 80;BA.debugLine="RightPositions.Add(Left)";
_vvvvvvvvv2.Add((Object)(_left));
 }
};
...
public int  _vvvvvvvv3(int _left,String _text,boolean _first,boolean _last,int _clr,int _strokecolor) throws Exception{
...
_r = _vvvvvvvv0.MeasureText(_text,_vvvvvvvvv4);
...
_itemheight = (int) (_vvvvvvvv0.getTargetRect().getHeight());
 //BA.debugLineNum = 89;BA.debugLine="Dim BaseLine As Int = cvs.TargetRect.CenterY - r.";
_baseline = (int) (_vvvvvvvv0.getTargetRect().getCenterY()-_r.getHeight()/(double)2-_r.getTop());
...
_p.LineTo((float) (_left+_itemwidth+_vvvvvvvvv5),(float) (_itemheight/(double)2));
 };
...
_p.LineTo((float) (_left-_vvvvvvvvv5),(float) (_itemheight));
...
_p.LineTo((float) (_left-_vvvvvvvvv5),(float) (0));
 }else {
...
_vvvvvvvv0.DrawPath(_p,_clr,__c.True,(float) (0));
...
_vvvvvvvv0.DrawPath(_p,_strokecolor,__c.False,(float) (__c.DipToCurrent((int) (3))));
 };
 //BA.debugLineNum = 110;BA.debugLine="cvs.DrawText(Text, Left + ItemWidth / 2, BaseLine";
_vvvvvvvv0.DrawText(ba,_text,(float) (_left+_itemwidth/(double)2),(float) (_baseline),_vvvvvvvvv4,_vvvvvvvvv3,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 111;BA.debugLine="Return ItemWidth";
if (true) return _itemwidth;
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return 0;
}
public int  _vvvvvvvv4(int _x,int _y) throws Exception{
int _r = 0;
int _i = 0;
...
_i = (int) (_vvvvvvvvv2.getSize()-2) ;
for (;_i >= limit5 ;_i = _i + step5 ) {
 //BA.debugLineNum = 142;BA.debugLine="Dim r As Int = RightPositions.Get(i)";
_r = (int)(BA.ObjectToNumber(_vvvvvvvvv2.Get(_i)));
...
public anywheresoftware.b4a.objects.collections.List  _getvvvvvvvv7() throws Exception{
...
_vvvvvvvvv1.Initialize();
 //BA.debugLineNum = 28;BA.debugLine="RightPositions.Initialize";
_vvvvvvvvv2.Initialize();
 //BA.debugLineNum = 29;BA.debugLine="bc.Initialize(1, 1)";
_vvvvvv0._initialize(ba,(int) (1),(int) (1));
 //BA.debugLineNum = 30;BA.debugLine="End Sub";
return "";
}
public String  _setvvvvvvvv7(anywheresoftware.b4a.objects.collections.List _i) throws Exception{
...
__c.CallSubNew2(ba,_vvv3,_vvv2+"_CrumbClick",(Object)(_items));
 };
