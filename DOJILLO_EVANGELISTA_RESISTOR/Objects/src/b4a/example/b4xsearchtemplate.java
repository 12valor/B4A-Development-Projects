...
public b4a.example.b4xdialog _vvvvvvvvvvvvv7 = null;
public b4a.example.b4xfloattextfield _searchfield = null;
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = null;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = 0;
public int _max_limit = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = 0;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = "";
public anywheresoftware.b4a.objects.IME _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
public boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = false;
public boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = false;
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(anywheresoftware.b4a.objects.collections.List _li,String _full) throws Exception{
int _i = 0;
String _item = "";
int _x = 0;
int _pnlcolor = 0;
...
if (_customlistview1._getsize()>=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4) { 
if (true) return "";};
...
if (_customlistview1._getsize()==0 && _full.length()>0 && _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0==__c.False) { 
 //BA.debugLineNum = 143;BA.debugLine="pnlColor = ItemHightlightColor";
_pnlcolor = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3;
 }else {
...
_cs.Initialize().Append(BA.ObjectToCharSequence(_item.substring((int) (0),_x))).Color(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2).Append(BA.ObjectToCharSequence(_item.substring(_x,(int) (_x+_full.length())))).Pop();
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getSize()>0) { 
 //BA.debugLineNum = 152;BA.debugLine="Dim p As B4XView = ItemsCache.Get(ItemsCache.Si";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Get((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getSize()-1))));
 //BA.debugLineNum = 153;BA.debugLine="ItemsCache.RemoveAt(ItemsCache.Size - 1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.RemoveAt((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getSize()-1));
...
_vvvvvvvvvvvvv7 = new b4a.example.b4xdialog();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 8;BA.debugLine="Private substringList As Map";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 9;BA.debugLine="Public TextHighlightColor As Int = 0xFFFD5C5C";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = ((int)0xfffd5c5c);
 //BA.debugLineNum = 10;BA.debugLine="Public ItemHightlightColor As Int = 0x7E008EFF";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = ((int)0x7e008eff);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = (int) (100);
 //BA.debugLineNum = 13;BA.debugLine="Private ItemsCache As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = false;
 //BA.debugLineNum = 21;BA.debugLine="Public PrefixOnly As Boolean";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = false;
...
_vvv4.SetLayoutAnimated((int) (0),(int) (0),(int) (0),__c.DipToCurrent((int) (300)),_height);
 //BA.debugLineNum = 30;BA.debugLine="mBase.LoadLayout(\"SearchTemplate\")";
_vvv4.LoadLayout("SearchTemplate",ba);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Initialize();
 //BA.debugLineNum = 45;BA.debugLine="prefixList.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Initialize();
 //BA.debugLineNum = 46;BA.debugLine="substringList.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Initialize();
 //BA.debugLineNum = 48;BA.debugLine="IME.Initialize(\"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Initialize("");
 //BA.debugLineNum = 49;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().getObject()));
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0) { 
 //BA.debugLineNum = 114;BA.debugLine="SelectedItem = LastTerm";
_vvvvvvvvvvvvvvv1 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7;
 //BA.debugLineNum = 115;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
_vvvvvvvvvvvvv7._vvvvvvvvvvvvvvvvvvvv4 /*boolean*/ (_vvv5.DialogResponse_Positive);
 }else if(_customlistview1._getsize()>0 && _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.length()>0) { 
...
_vvvvvvvvvvv7(_new,__c.False);
 //BA.debugLineNum = 83;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(Object _index) throws Exception{
Object[] _obj = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_obj[(int) (0)]));
 //BA.debugLineNum = 237;BA.debugLine="substringList = obj(1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_obj[(int) (1)]));
 //BA.debugLineNum = 238;BA.debugLine="Dim AllItems As List = obj(2)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.collections.List();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_obj[(int) (2)]));
 //BA.debugLineNum = 239;BA.debugLine="End Sub";
return "";
}
public Object  _vvvvvvvv6(anywheresoftware.b4a.objects.collections.List _items) throws Exception{
long _starttime = 0L;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Clear();
 //BA.debugLineNum = 202;BA.debugLine="substringList.Clear";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Clear();
...
{
final int step13 = 1;
final int limit13 = (int)(BA.ObjectToNumber(((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1) ? ((Object)(0)) : ((Object)(_itemtolower.length()-1)))));
_start = (int) (0) ;
...
if (_start==0) { 
_m = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0;}
else {
_m = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1;};
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = _items;
 //BA.debugLineNum = 229;BA.debugLine="Return Array(prefixList, substringList, AllItems)";
if (true) return (Object)(new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getObject()),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getObject()),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.getObject())});
...
parent._vvvvvvvvvvvvv7._vvvvvvvvvvvvvvvvvvvvvvvv3 /*boolean*/  = parent._vvv5.getIsB4A() || parent._vvv5.getIsB4i();
 //BA.debugLineNum = 68;BA.debugLine="CustomListView1.AsView.Color = xui.Color_Transpar";
parent._customlistview1._asview().setColor(parent._vvv5.Color_Transparent);
 //BA.debugLineNum = 69;BA.debugLine="CustomListView1.sv.Color = xui.Color_Transparent";
parent._customlistview1._sv.setColor(parent._vvv5.Color_Transparent);
 //BA.debugLineNum = 70;BA.debugLine="mBase.Color = xui.Color_Transparent";
parent._vvv4.setColor(parent._vvv5.Color_Transparent);
...
parent._vvvvvvvvvvv7("",parent.__c.True);
...
parent._searchfield._setvvvvvvvvvvvvvvvvvvvvvvvvvvv3 /*String*/ ("");
 //BA.debugLineNum = 75;BA.debugLine="SearchField.TextField.RequestFocus";
parent._searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().RequestFocus();
 //BA.debugLineNum = 77;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.ShowKeyboard((android.view.View)(parent._searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().getObject()));
...
public String  _vvvvvvvvvvv7(String _term,boolean _force) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
String _str1 = "";
String _str2 = "";
...
if ((_term).equals(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7) && _force==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 87;BA.debugLine="LastTerm = Term";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _term;
 //BA.debugLineNum = 88;BA.debugLine="If xui.IsB4J = False Then";
if (_vvv5.getIsB4J()==__c.False) { 
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Add((Object)(_p.getObject()));
 }
};
 };
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,_str1);
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7((anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Get((Object)(_str2)))),_str1);
 //BA.debugLineNum = 108;BA.debugLine="AddItemsToList(substringList.Get(str2), str1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7((anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Get((Object)(_str2)))),_str1);
 };
