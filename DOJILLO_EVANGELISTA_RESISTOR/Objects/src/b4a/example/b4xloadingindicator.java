...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private index As Int";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _vvv5.PaintOrColorToColor(_props.Get((Object)("Color")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 32;BA.debugLine="SetStyle(style)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_style);
...
_r = (float) (_vvvvvvvv0.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
...
_p.InitializeArc(_vvvvvvvv0.getTargetRect().getCenterX(),_vvvvvvvv0.getTargetRect().getCenterY(),_r,(float) (-90),(float) (_progress*2*360));
 }else {
 //BA.debugLineNum = 118;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
_p.InitializeArc(_vvvvvvvv0.getTargetRect().getCenterX(),_vvvvvvvv0.getTargetRect().getCenterY(),_r,(float) (-90),(float) (-(1-_progress)*2*360));
 };
 //BA.debugLineNum = 120;BA.debugLine="cvs.ClipPath(p)";
_vvvvvvvv0.ClipPath(_p);
 //BA.debugLineNum = 121;BA.debugLine="cvs.DrawRect(cvs.TargetRect, IndicatorColor, True";
_vvvvvvvv0.DrawRect(_vvvvvvvv0.getTargetRect(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,__c.True,(float) (0));
 //BA.debugLineNum = 122;BA.debugLine="cvs.RemoveClip";
_vvvvvvvv0.RemoveClip();
...
_p.InitializeArc(_vvvvvvvv0.getTargetRect().getCenterX(),_vvvvvvvv0.getTargetRect().getCenterY(),_r,(float) (-90),(float) (360-(_progress-0.5)*2*360));
 };
...
_maxr = (int) (_vvvvvvvv0.getTargetRect().getHeight()/(double)2);
 //BA.debugLineNum = 105;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
_dx = (int) ((_vvvvvvvv0.getTargetRect().getWidth()-__c.DipToCurrent((int) (2)))/(double)5);
...
_vvvvvvvv0.DrawLine((float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvv0.getTargetRect().getCenterY()-_r),(float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvv0.getTargetRect().getCenterY()+_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,(float) (__c.DipToCurrent((int) (4))));
 }
};
...
_vvvvvvvv0.DrawCircle((float) (_vvvvvvvv0.getTargetRect().getWidth()-_dotr-_progress*(_vvvvvvvv0.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_vvvvvvvv0.getTargetRect().getCenterY(),(float) (_dotr),_vv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,(int) (255-200*_progress)),__c.True,(float) (0));
...
_cx = (int) (_vvvvvvvv0.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 144;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
_cy = (int) (_vvvvvvvv0.getTargetRect().getCenterY());
 //BA.debugLineNum = 145;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
_r = (int) (_vvvvvvvv0.getTargetRect().getCenterY()-__c.DipToCurrent((int) (5)));
...
_vvvvvvvv0.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,__c.True,(float) (0));
 }else {
...
_vvvvvvvv0.DrawCircle(_vvvvvvvv0.getTargetRect().getCenterX(),_vvvvvvvv0.getTargetRect().getCenterY(),(float) (_vvvvvvvv0.getTargetRect().getCenterX()*_progress),_vv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,(int) (255-255*_progress)),__c.True,(float) (0));
 }
};
...
_maxr = (float) ((_vvvvvvvv0.getTargetRect().getWidth()/(double)2-__c.DipToCurrent((int) (20)))/(double)2);
...
_vvvvvvvv0.DrawCircle((float) (_vvvvvvvv0.getTargetRect().getCenterX()+_r*__c.SinD(_alpha)),(float) (_vvvvvvvv0.getTargetRect().getCenterY()+_r*__c.CosD(_alpha)),(float) (__c.DipToCurrent((int) (7))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,__c.True,(float) (__c.DipToCurrent((int) (1))));
 }
};
...
_maxr = (int) (_vvvvvvvv0.getTargetRect().getWidth()/(double)2/(double)3-_minr-__c.DipToCurrent((int) (2)));
...
_vvvvvvvv0.DrawCircle((float) (_maxr+_minr+(_minr+_maxr+__c.DipToCurrent((int) (2)))*2*_i),_vvvvvvvv0.getTargetRect().getCenterY(),_r,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,__c.True,(float) (0));
 }
};
...
_vvv4.setVisible(__c.False);
 //BA.debugLineNum = 70;BA.debugLine="index = index + 1";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0+1);
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0+1);
 //BA.debugLineNum = 51;BA.debugLine="Dim MyIndex As Int = index";
_myindex = parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0;
...
//do while
this.state = 4;
while (_myindex==parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
...
parent._vvvvvvvv0.ClearRect(parent._vvvvvvvv0.getTargetRect());
 //BA.debugLineNum = 57;BA.debugLine="CallSub2(Me, DrawingSubName, progress)";
parent.__c.CallSubNew2(ba,parent,parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(Object)(_progress));
 //BA.debugLineNum = 58;BA.debugLine="cvs.Invalidate";
parent._vvvvvvvv0.Invalidate();
...
public int  _vv1(int _c,int _alpha) throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(String _style) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = "Draw_"+_style.replace(" ","");
