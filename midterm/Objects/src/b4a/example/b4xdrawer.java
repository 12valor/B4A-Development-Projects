...
public String _vvv3 = "";
public Object _vvv4 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper.XUI _vvv5 = null;
public int _vvv6 = 0;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvv7 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvv0 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvv1 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvv2 = null;
public int _vvvv3 = 0;
public float _vvvv4 = 0f;
public float _vvvv5 = 0f;
public boolean _vvvv6 = false;
public boolean _vvvv7 = false;
public boolean _vvvv0 = false;
public boolean _vvvvv1 = false;
public b4a.example.main _vvvvv2 = null;
...
switch (BA.switchObjectToInt(_action,_vvvv1.TOUCH_ACTION_DOWN,_vvvv1.TOUCH_ACTION_MOVE)) {
case 0: {
...
_leftpanelrightside = (int) (_vvv7.getLeft()+_vvv7.getWidth());
 //BA.debugLineNum = 69;BA.debugLine="If HandlingSwipe = False And x > LeftPanelRightSi";
if (_vvvv7==__c.False && _x>_leftpanelrightside) { 
...
if (_vvvv7 || __c.Abs(_dx)>__c.DipToCurrent((int) (3))) { 
...
_v5((float) (_vvv7.getLeft()+_dx),__c.True,__c.False);
 };
 break; }
case 1: {
...
_v5((float) (_vvv7.getLeft()),__c.False,__c.False);
 };
...
public String  _v5(float _x,boolean _currentlytouching,boolean _noanimation) throws Exception{
...
if ((_vvvv6 && _visibleoffset<0.8*_vvv6) || (_vvvv6==__c.False && _visibleoffset<0.2*_vvv6)) { 
...
_dx = (int) (__c.Abs(_vvv7.getLeft()-_x));
 //BA.debugLineNum = 195;BA.debugLine="Dim duration As Int = Max(0, 200 * dx / mSideWid";
_duration = (int) (__c.Max(0,200*_dx/(double)_vvv6));
...
_vvv7 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 8;BA.debugLine="Private mDarkPanel As B4XView";
_vvv0 = new anywheresoftware.b4a.objects.B4XViewWrapper();
...
_vvvv2 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 11;BA.debugLine="Public ExtraWidth As Int = 50dip";
_vvvv3 = __c.DipToCurrent((int) (50));
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getvv7() throws Exception{
...
if (true) return _vvvv6;
 //BA.debugLineNum = 228;BA.debugLine="End Sub";
return false;
}
public anywheresoftware.b4a.objects.B4XViewWrapper  _getvvv2() throws Exception{
...
_vvvv1 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_creator.CreateTouchPanel(ba,"base").getObject()));
 //BA.debugLineNum = 34;BA.debugLine="Parent.AddView(mBasePanel, 0, 0, Parent.Width, Pa";
_parent.AddView((android.view.View)(_vvvv1.getObject()),(int) (0),(int) (0),_parent.getWidth(),_parent.getHeight());
 //BA.debugLineNum = 35;BA.debugLine="mCenterPanel = xui.CreatePanel(\"\")";
_vvvv2 = _vvv5.CreatePanel(ba,"");
 //BA.debugLineNum = 36;BA.debugLine="mBasePanel.AddView(mCenterPanel, 0, 0, mBasePanel";
_vvvv1.AddView((android.view.View)(_vvvv2.getObject()),(int) (0),(int) (0),_vvvv1.getWidth(),_vvvv1.getHeight());
 //BA.debugLineNum = 37;BA.debugLine="mDarkPanel = xui.CreatePanel(\"dark\")";
_vvv0 = _vvv5.CreatePanel(ba,"dark");
 //BA.debugLineNum = 38;BA.debugLine="mBasePanel.AddView(mDarkPanel, 0, 0, mBasePanel.W";
_vvvv1.AddView((android.view.View)(_vvv0.getObject()),(int) (0),(int) (0),_vvvv1.getWidth(),_vvvv1.getHeight());
 //BA.debugLineNum = 39;BA.debugLine="mLeftPanel = xui.CreatePanel(\"LeftPanel\")";
_vvv7 = _vvv5.CreatePanel(ba,"LeftPanel");
 //BA.debugLineNum = 40;BA.debugLine="mBasePanel.AddView(mLeftPanel, -SideWidth, 0, Sid";
_vvvv1.AddView((android.view.View)(_vvv7.getObject()),(int) (-_sidewidth),(int) (0),_sidewidth,_vvvv1.getHeight());
 //BA.debugLineNum = 41;BA.debugLine="mLeftPanel.Color = xui.Color_Red";
_vvv7.setColor(_vvv5.Color_Red);
 //BA.debugLineNum = 43;BA.debugLine="Dim p As Panel = mLeftPanel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
_p = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(_vvv7.getObject()));
...
public int  _vv2(int _x) throws Exception{
float _visible = 0f;
...
_visible = (float) ((_vvv6+_x)/(double)_vvv6);
 //BA.debugLineNum = 223;BA.debugLine="Return xui.Color_ARGB(100 * Visible, 0, 0, 0)";
if (true) return _vvv5.Color_ARGB((int) (100*_visible),(int) (0),(int) (0),(int) (0));
 //BA.debugLineNum = 224;BA.debugLine="End Sub";
return 0;
}
public String  _vv3(int _width,int _height) throws Exception{
...
if (_vvvv6) { 
_v5((float) (-_vvv6),__c.False,__c.True);};
 //BA.debugLineNum = 247;BA.debugLine="mBasePanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
_vvvv1.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 248;BA.debugLine="mLeftPanel.SetLayoutAnimated(0, mLeftPanel.Left,";
_vvv7.SetLayoutAnimated((int) (0),_vvv7.getLeft(),(int) (0),_vvv7.getWidth(),_vvvv1.getHeight());
 //BA.debugLineNum = 249;BA.debugLine="mDarkPanel.SetLayoutAnimated(0, 0, 0, Width, Heig";
_vvv0.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 250;BA.debugLine="mCenterPanel.SetLayoutAnimated(0, 0, 0, Width, He";
_vvvv2.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 251;BA.debugLine="End Sub";
return "";
}
public String  _setvv0(boolean _b) throws Exception{
...
public String  _vv5(boolean _newstate) throws Exception{
...
if (_vvv5.SubExists(ba,_vvv4,_vvv3+"_StateChanged",(int) (1))) { 
 //BA.debugLineNum = 217;BA.debugLine="CallSubDelayed2(mCallBack,  mEventName & \"_State";
__c.CallSubDelayed2(ba,_vvv4,_vvv3+"_StateChanged",(Object)(_vvvv6));
 };
